        ...
        public static OrdersDbContext SeedOrders(this OrdersDbContext context)
        {
            if (!context.Orders.Any())
            {
                context.Orders.Add(new DB.Order()
                {
                    ...
                    {
                    new() { OrderId = new Guid("ed83a911-a078-4b5c-bda0-8a4e80f32b39"), ProductId = new Guid("6C60378B-71D5-4920-B763-6AFCADA6267E"), Quantity = 10, UnitPrice = 10 },
                    new() { OrderId = new Guid("ed83a911-a078-4b5c-bda0-8a4e80f32b39"), ProductId = new Guid("5C60378B-71D5-4920-B763-6AFCADA6267E"), Quantity = 10, UnitPrice = 10 },
                    new() { OrderId = new Guid("ed83a911-a078-4b5c-bda0-8a4e80f32b39"), ProductId = new Guid("4C60378B-71D5-4920-B763-6AFCADA6267E"), Quantity = 10, UnitPrice = 10 },
                    new() { OrderId = new Guid("4cb0c381-3f9d-460c-9796-2635c500eb46"), ProductId = new Guid("5C60378B-71D5-4920-B763-6AFCADA6267E"), Quantity = 10, UnitPrice = 10 },
                    new() { OrderId = new Guid("4cb0c381-3f9d-460c-9796-2635c500eb46"), ProductId = new Guid("4C60378B-71D5-4920-B763-6AFCADA6267E"), Quantity = 1, UnitPrice = 100 }
                    },
                    Total = 100
                });
                context.Orders.Add(new DB.Order()
